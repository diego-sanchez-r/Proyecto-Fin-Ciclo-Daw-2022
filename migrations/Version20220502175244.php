 ...
 */
final class Version20220502175244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comentario ADD incidencia_id INT DEFAULT NULL, ADD usuario_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comentario DROP incidencia_id, DROP usuario_id');
